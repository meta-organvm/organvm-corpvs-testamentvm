...
| IRF-SYS-058 | **P2** | **Generalize Xenograft Protocol from sovereign-systems to ORGAN-IV.** The content extraction + atomization + verification pipeline (SOP-SS-CNT-001 + SOP-SS-ATM-001) should become a system-wide protocol in ORGAN-IV for any organ receiving alien material. Strip Maddie-specific details, parameterize domain. | Agent | S-2026-04-03 session generalization | None |
