...
| IRF-INST-002 | **P0** | **Apply to Creative Capital Award 2027** — $15K-$50K unrestricted. **DRAFT COMPLETE (S-client-pillar).** All text fields populated at `aerarium--res-publica/applications/creative-capital-2027/draft.md`. **REMAINING:** (1) Record work sample video/screenshots of Alchemical Synthesizer, (2) Create art-only resume PDF, (3) Character count verification on all fields, (4) Human review + web form submission. Deadline: **April 2, 2026 3:00 PM ET**. | Human | S37→S-client-pillar | Work sample video + resume PDF + human submission |
