...
Purpose: Universal hanging index of things to be done — the canonical gap between what the system IS and what it NEEDS TO BE. (872 items, 20 domains)
...
| IRF-CND-029 | **P1** | **Dress vox repos for absorption.** vox--architectura-gubernatio and vox--publica both MISSING: AGENTS.md, GEMINI.md, ecosystem.yaml, CHANGELOG.md. Active absorb repos (→ immune--score) must have full ceremony BEFORE cocoon ingestion — the absorbing function needs multi-agent context to understand what it's absorbing. | Agent | S-dissection vacuum-fill (2026-04-04) | None |
