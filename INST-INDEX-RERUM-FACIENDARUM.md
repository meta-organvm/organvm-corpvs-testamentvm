...
| ID | Priority | Action | Owner | Source | Blocker |
|----|----------|--------|-------|--------|---------|
| ~~IRF-DSF-001~~ | ~~P1~~ | ~~**Layer 0: Write SPEC-022 grounding paper**~~ — **DONE-312**: 4 files in `post-flood/specs/SPEC-022-dispersio-formalis/` (grounding.md 303 lines, literature-matrix.md 119 lines, risk-register.md 63 lines, inventory.md 123 lines). 650 total lines. 13 sources, 15 claims, 27 terms, 5-layer implementation surface. Plan at `.claude/plans/2026-04-01-dispersio-formalis.md`. | Agent | S-dispersio-formalis (2026-04-01) | Completed |
...
| IRF-APP-065 | P2 | Update seed.yaml with new capabilities from S43 wiring tests. | Agent | S43 hall-monitor audit | None |
| IRF-APP-066 | P0 | Daily email review and pipeline triage (S48 milestone). | Agent | S48 daily audit | None |
