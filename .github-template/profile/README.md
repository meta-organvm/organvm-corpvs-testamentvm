...
<!-- Use: gh repo list {{ORG_NAME}} --json name,description --template '...' -->

*Repositories are being prepared for launch. Check back soon.*

## Part of the organvm System

This organization is one of 8 in the [organvm system](https://github.com/{{META_ORG}}):
...
<sub>{{ORG_DISPLAY_NAME}} &mdash; part of the eight-organ creative-institutional system</sub>
