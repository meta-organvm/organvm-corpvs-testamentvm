...
- Root cause: 94 workflows running on every push across 105 repos
...
4. **Slide 13:** Run `organvm seed validate` — show the system verifying its own structural integrity across 105 repos.
...
| Metric | Value | Source |
|--------|-------|--------|
| Total repositories | 105 | registry-v2.json |
