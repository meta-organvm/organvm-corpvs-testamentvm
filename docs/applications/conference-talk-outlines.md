...
- The governance corpus (~766K+ words) is evidence of capability
...
- The governance corpus (~766K+ words), the registry, the schemas
...
| Documentation volume | ~766K+ words | system metrics |
