...
- Root cause: 104 workflows running on every push across 124 repos
...
4. **Slide 13:** Run `organvm seed validate` — show the system verifying its own structural integrity across 124 repos.
...
| Metric | Value | Source |
|--------|-------|--------|
| Total repositories | 124 | registry-v2.json |
