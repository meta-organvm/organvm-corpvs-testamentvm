...
- Current pipeline: 4 GRADUATED, 29 PUBLIC_PROCESS, 55 CANDIDATE, 6 LOCAL, 9 ARCHIVED
...
- Root cause: 94 workflows running on every push across 103 repos
...
- Current state: 4 GRADUATED, 29 PUBLIC_PROCESS, 55 CANDIDATE, 6 LOCAL, 9 ARCHIVED
...
4. **Slide 13:** Run `organvm seed validate` — show the system verifying its own structural integrity across 103 repos.
...
| Metric | Value | Source |
|--------|-------|--------|
| Total repositories | 103 | registry-v2.json |
...
| CI/CD workflows | 94+ | registry-v2.json |
