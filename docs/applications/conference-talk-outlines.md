...
- Root cause: 104 workflows running on every push across 125 repos
...
4. **Slide 13:** Run `organvm seed validate` — show the system verifying its own structural integrity across 125 repos.
...
| Metric | Value | Source |
|--------|-------|--------|
| Total repositories | 125 | registry-v2.json |
