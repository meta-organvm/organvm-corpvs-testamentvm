...
| CI/CD workflows | 106+ repos with workflows |
| Dependency edges | 60 validated |
...
Systems artist. Creator of the ORGANVM eight-organ system — 100 repositories, 8 organizations, 42 essays, ~766K+ words. Builds creative infrastructure at institutional scale using AI tools as compositional instruments. MFA Creative Writing, 18 years professional experience. NYC-based.
...
| 2 | Eight-Organ System Hub | https://github.com/meta-organvm/organvm-corpvs-testamentvm | Governance corpus: ~766K+ words, registry, orchestration specs, 33 sprint records |
| 3 | Public Process Essays | https://organvm-v-logos.github.io/public-process/ | 0 essays documenting creative methodology in real time (~766K+ words) |
...
5. **Radical transparency at system scale.** Every decision, sprint, failure, and course correction is documented and published. ~766K+ words, 33 sprint specs, 12 ADRs, a constitution with amendments — the entire institutional memory is public.
...
- **Evidence:** 128-repo eight-organ system as living creative work, 42 essays, MFA
...
- **Evidence:** Multi-agent orchestration, autonomous governance, 2,349+ tests, 106+ CI/CD workflows
...
| 72 ACTIVE, 54 ARCHIVED | registry-v2.json | implementation_status_distribution field |
| 42 published essays | public-process/_posts/ | `ls _posts/ \| wc -l` → 42 |
| ~766K+ words in essays | Word count of _posts/ | Measured at deploy |
...
| 106+ CI/CD workflows | Per-repo .github/workflows/ | Counted in MANIFESTATIO audit |
| 60 dependency edges, 0 violations | validate-dependencies.yml | Weekly automated check |
...
| No published book | 42 essays (~766K+ words) but no book | "Sustained nonfiction practice" or "book-length corpus" |
