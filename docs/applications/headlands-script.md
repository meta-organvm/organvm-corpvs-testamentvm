# Submission Script — Headlands Center for the Arts

**Created:** 2026-02-18
**Time to complete:** ~30-45 minutes
**URL:** https://www.headlands.org/
**Deadline:** April 1 - June 1, 2026
**Award:** Fully funded (airfare + meals + housing + $1K/month)
**Identity position:** Systems Artist (secondary: Community Practitioner)
**Benefits cliff:** $1K/month stipend is low. SNAP-safe.
...
- [ ] Open application: https://www.headlands.org/
...
A residency at Headlands Center for the Arts would provide the focused time and creative community to advance the most challenging next phase of this work — moving from documented infrastructure to active community engagement and public presentation.
...
- [ ] Update status: `headlands` → SUBMITTED
