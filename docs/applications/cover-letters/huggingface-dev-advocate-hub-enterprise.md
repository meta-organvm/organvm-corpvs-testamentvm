...
- 128 repository READMEs, each written for grant reviewers and hiring managers
...
- organvm-corpvs-testamentvm as the meta-governance document — ~766K+ words of structured technical writing that IS the product
