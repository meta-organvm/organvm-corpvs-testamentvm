...
- **Notes:** No years requirement — purely skills-based. Content creation proven at scale (~404K+ words, 40 essays). HF hires 30-40% from community. Gap: no HF library contributions, no published ML tutorials. Skills-based evaluation favors non-traditional backgrounds. Remote-first.
