...
The ORGANVM system is an eight-organ creative-institutional platform spanning 97 repositories across 8 GitHub organizations. It coordinates theory (ORGAN-I), art (ORGAN-II), commerce (ORGAN-III), orchestration (ORGAN-IV), public process (ORGAN-V), community (ORGAN-VI), marketing (ORGAN-VII), and meta-governance (Meta).
