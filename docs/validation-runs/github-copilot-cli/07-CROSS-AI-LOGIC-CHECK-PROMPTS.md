...
1. `organvm.env` — Read first: the naming architecture (env-var template)
2. `organvm.config.json` — Read second: machine-readable org mapping
3. `registry-v2.json` — Read third: the central registry (source of truth for all repos)
4. `orchestration-system-v2.md` — Read fourth: governance rules and dependency model
5. `github-actions-spec.md` — Read fifth: the 5 workflows that consume the registry
6. `06-EVALUATION-TO-GROWTH-ANALYSIS.md` — Read last: the independent evaluation you're validating
...
**Attach these files in this order:**
1. `00-c-MASTER-SUMMARY.md` — Read first: executive summary of the entire system
2. `PARALLEL-LAUNCH-STRATEGY.md` — Read second: strategic rationale for simultaneous launch
3. `IMPLEMENTATION-PACKAGE-v2.md` — Read third: the master execution plan with TE budgets and phases
4. `orchestration-system-v2.md` — Read fourth: governance model and dependency rules
5. `public-process-map-v2.md` — Read fifth: ORGAN-V content strategy and distribution plan
6. `06-EVALUATION-TO-GROWTH-ANALYSIS.md` — Read last: the independent evaluation you're validating
...
**Attach these files in this order:**
1. `01-README-AUDIT-FRAMEWORK.md` — Read first: the scoring rubric (0-100) for README quality
2. `02-REPO-INVENTORY-AUDIT.md` — Read second: per-repo inventory with current scores and TE budgets
3. `03-PER-ORGAN-README-TEMPLATES.md` — Read third: the 12-section README template
4. `05-RISK-MAP-AND-SEQUENCING.md` — Read fourth: risk identification and writing sequence
5. `registry-v2.json` — Read fifth: the actual repo data (names, orgs, status, relevance)
6. `06-EVALUATION-TO-GROWTH-ANALYSIS.md` — Read last: the independent evaluation you're validating
